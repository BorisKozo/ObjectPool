(function (exports) {
  ...
  exports.$Generator = function (target, options) {
    ...
    if (this.options.data) {
      for (tempValue in this.options.data) {
        this.pool.release(tempValue);
      }
  ...
  exports.$Generator.prototype.tryRegenerate = function () {
    if (isFunction(this.options.regenerate)) {
      tempValue = this.options.regenerate.apply(this);
    } else {
      tempValue = this.options.regenerate.valueOf();
    }

    this.create(tempValue);
  }
